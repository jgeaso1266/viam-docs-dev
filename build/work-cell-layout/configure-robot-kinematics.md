...
- What kinematics are and why they matter for arm motion
- The difference between forward and inverse kinematics
- How Viam represents kinematics using SVA, Denavit-Hartenberg, and URDF formats
- How links and joints define the structure of an arm
- How to check whether your arm module includes a built-in kinematics file
- How to read joint positions and end effector poses programmatically
- How to verify kinematics visually
...
This block covers the kinematics concepts, shows you how to inspect and verify
your arm's kinematic configuration, and demonstrates how to read joint and end
effector data programmatically.
...
- A machine with a configured arm component
- The arm module must include a kinematics file (most registry modules do)
- Frame system configured for the arm (from [Define Your Frame System](define-your-frame-system.md))
...
### VISUALIZE tab does not match the physical arm
...
- [Move to Pose](../arm-manipulation/move-to-pose.md) -- use inverse kinematics
